...
if show_sources == "Yes":
    if source == "All":
        fig_source.add_trace(px.scatter_mapbox(df_location_filtering, lat='lat', lon='lon', size='production', color='energy_source_level_2', hover_name="municipality", hover_data=["canton","production", "project_name","company",'energy_source_level_2']).data[0])
